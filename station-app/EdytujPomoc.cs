...
{
    public partial class EdytujPomoc : Form
    {
        HarmonogramPomocyForm pomoce;
        DataAccess db = new DataAccess();

        public EdytujPomoc(HarmonogramPomocyForm xpomoce, List<string> parameters)
        {
            pomoce = xpomoce;
            InitializeComponent();
        ...
        public void LoadElements(List<string> parameters)
        {
            ...
            data2dateTimePicker.Value = DateTime.Parse(parameters[1]);
